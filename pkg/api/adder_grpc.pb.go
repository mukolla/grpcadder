...
const (
	...
	Adder_SetName_FullMethodName = "/api.Adder/SetName"
)
...
type AdderClient interface {
	...
	SetName(ctx context.Context, in *Person, opts ...grpc.CallOption) (*PersonFullName, error)
}
...
func (c *adderClient) SetName(ctx context.Context, in *Person, opts ...grpc.CallOption) (*PersonFullName, error) {
	out := new(PersonFullName)
	err := c.cc.Invoke(ctx, Adder_SetName_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdderServer interface {
	...
	SetName(context.Context, *Person) (*PersonFullName, error)
...
func (UnimplementedAdderServer) SetName(context.Context, *Person) (*PersonFullName, error) {
...
func _Adder_SetName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Person)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdderServer).SetName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Adder_SetName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdderServer).SetName(ctx, req.(*Person))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Adder_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetName",
			Handler:    _Adder_SetName_Handler,
		},
	},
